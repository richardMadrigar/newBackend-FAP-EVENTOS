...
export const createUser = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const SQL_permissao = 'INSERT INTO permissao_usuarios ( id_usuario, permissao, nome_completo, cpf_usuario ) VALUES( $1, $2, $3, $4 )';
    const values_permissao = [id_usuario, permission, nome_completo, cpf];
